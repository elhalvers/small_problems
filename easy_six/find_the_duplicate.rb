...
Write a method that will find and return 
...
first ideas:
create a variable for first element of the array

nested loop (2 pointers ?)
expensive process! easier solutiion?
Outer loop moves through,
inner loop checks if matches current el in outer loop
